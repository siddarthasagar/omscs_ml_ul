...
figures were regenerated.  Every plot in the revised report --- clustering
sweeps, DR variance curves, heatmaps, NN learning curves --- is now
readable at the printed page width without zoom.

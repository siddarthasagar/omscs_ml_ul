...
\begin{table}[!ht]
  \caption{Silhouette in reduced spaces at reduced-space $K$ vs.\ raw baseline.
           Bold\,=\,best per row.}
  \label{tab:phase4}
...
comparison at the reduced-space $K$ values.  The hypothesis is directionally confirmed: Adult K-Means gains

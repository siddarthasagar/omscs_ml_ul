...
2. `scripts/run_phase_2_raw_cluster.py`:
   ...
   - save 4 CSVs to `artifacts/phase2_clustering/`:
...
4. `scripts/run_phase_3_raw_reduction.py`:
   ...
   - save diagnostic CSVs to `artifacts/phase3_reduction/`:
...
1. `scripts/run_phase_4_reduced_cluster.py`:
   ...
   - save `artifacts/phase4_reduced_clustering/summary_table.csv` with 12 rows and cols `[dataset, dr_method, clusterer, silhouette, calinski_harabasz, davies_bouldin_or_bic]`
...
3. `scripts/run_phase_5_nn_reduced.py`:
   ...
   - save `artifacts/phase5_nn_reduced/comparison_table.csv` with cols `[variant, seed, val_macro_f1, test_macro_f1, epochs_to_converge]`
...
1. `scripts/run_phase_6_nn_cluster_features.py`:
   ...
   - save `artifacts/phase6_nn_cluster/comparison_table.csv`
...
2. `scripts/run_phase_7_tsne.py`:
   ...
   - generate 2D scatter with label overlay → `artifacts/phase7_tsne/wine_tsne_labels.png`, `adult_tsne_labels.png`
